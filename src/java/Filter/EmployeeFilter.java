...
public class EmployeeFilter implements Filter {
	...
	if (debug) log("EmployeeFilter:DoBeforeProcessing");
	...
	*/
	...
	throws IOException, ServletException {
	if (debug) log("EmployeeFilter:DoAfterProcessing");
	...
	*/
	...
	if (debug) log("EmployeeFilter:doFilter()");
	...
	if (filterConfig == null) return ("EmployeeFilter()");
