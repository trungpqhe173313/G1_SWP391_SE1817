    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!dao.checkEmailExist(emailReset)) {
                request.setAttribute("mess", "Không tìm thấy email của bạn");
                request.getRequestDispatcher("resetPasswordC.jsp").forward(request, response);
            } else {
                ...
                if (otp != null) {
                    ...
                    request.setAttribute("mess", "Lỗi máy chủ, vui lòng thử lại sau.");
                    request.getRequestDispatcher("resetPasswordC.jsp").forward(request, response);
                }
            }
        } catch (SQLException ex) {
            Logger.getLogger(sendlink.class.getName()).log(Level.SEVERE, null, ex);
            request.setAttribute("mess", "Database error, please try again later.");
            request.getRequestDispatcher("resetPasswordC.jsp").forward(request, response);
        }
    }
