        ...
        <div class="container">
            <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
                <div class="col-md-9 ftco-animate pb-5 text-center">
                    ...
                    <p class="breadcrumbs"><span class="mr-2"><a href="homepage.jsp">Trang Chủ <i class="ion-ios-arrow-round-forward"></i></a></span> <span>Blog</span></p>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="blog-entry mb-4">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="meta">
                                    <span class="date"><fmt:formatDate value="${blog.createAt}" pattern="yyyy-MM-dd" /></span>
                                </div>
