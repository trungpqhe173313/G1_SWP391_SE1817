<%-- 
    Document   : contact
    Created on : May 25, 2024, 2:54:58 AM
    Author     : phamt
--%>
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate pb-5 text-center">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="homepage.jsp">Home <i class="ion-ios-arrow-round-forward"></i></a></span> <span>Blog <i class="ion-ios-arrow-round-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="row">
          <div class="col-lg-8 ftco-animate">
		            ...
		            <div class="blog-entry align-self-stretch d-md-flex">
		              <a href="blog-single.jsp" class="block-20" style="background-image: url('images/work-1.jpg');">
		              </a>
		          ...
		          <div class="col-md-12 d-flex ftco-animate">
		            <div class="blog-entry align-self-stretch d-md-flex">
		              <a href="blog-single.jsp" class="block-20" style="background-image: url('images/work-2.jpg');">
		              </a>
		              <div class="text d-block pl-md-4">
		              	<div class="meta mb-3">
		                  <div><a href="#">Sept. 12, 2019</a></div>
		          ...
		          <div class="col-md-12 d-flex ftco-animate">
		            <div class="blog-entry align-self-stretch d-md-flex">
		              <a href="blog-single.jsp" class="block-20" style="background-image: url('images/work-3.jpg');">
		              </a>
		              <div class="text d-block pl-md-4">
		              	<div class="meta mb-3">
		                  <div><a href="#">Sept. 12, 2019</a></div>
		          ...
		          <div class="col-md-12 d-flex ftco-animate">
		            <div class="blog-entry align-self-stretch d-md-flex">
		              <a href="blog-single.jsp" class="block-20" style="background-image: url('images/work-4.jpg');">
		              </a>
		              <div class="text d-block pl-md-4">
		              	<div class="meta mb-3">
		                  <div><a href="#">Sept. 12, 2019</a></div>
		          ...
		          <div class="col-md-12 d-flex ftco-animate">
		            <div class="blog-entry align-self-stretch d-md-flex">
		              <a href="blog-single.jsp" class="block-20" style="background-image: url('images/work-5.jpg');">
		              </a>
		              <div class="text d-block pl-md-4">
		              	<div class="meta mb-3">
		                  <div><a href="#">Sept. 12, 2019</a></div>
		          ...
		          <div class="col-md-12 d-flex ftco-animate">
		            <div class="blog-entry align-self-stretch d-md-flex">
		              <a href="blog-single.jsp" class="block-20" style="background-image: url('images/work-6.jpg');">
		              </a>
		              <div class="text d-block pl-md-4">
		              	<div class="meta mb-3">
		                  <div><a href="#">Sept. 12, 2019</a></div>
