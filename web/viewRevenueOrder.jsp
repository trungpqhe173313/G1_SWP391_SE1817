<%-- 
    Document   : viewRevenueOrder
    Created on : Jun 16, 2024, 5:27:58 PM
    Author     : xdrag
--%>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- DataTales Example -->
                        <div class="wrapper" style="margin: auto; width: 80%;max-width: 700px; height: 100%;">
                            <div class="form" style="width: 100%;">
                                <h1 class="title">Chi Tiết Đơn Hàng</h1>

                                <div  class="myform" style="height: 900px;">
                                    ...
                                    <div class="control-from">
                                        <p style="font-size: 1.7rem;
                                           font-weight: 700;
                                           color: green;">
                                            Tổng Tiền: ${o.getOrder().getTotalAmount()}đ</p>
                                    </div>
                                    <div class="control-from">
                                        <p style="font-size: 1.5rem;
                                           font-weight: 700;
                                           color: rgb(15, 129, 223);">
                                            Trạng Thái: ${o.getStatus().getName()}</p>
                                    </div>
